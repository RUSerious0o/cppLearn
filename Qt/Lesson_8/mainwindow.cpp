...
void MainWindow::onAddDateToTextActionTriggered()
{
    QString text = ui->textEdit->textCursor().selectedText().append(
...
void MainWindow::setupToolBar()
{
    ...
    action = new QAction(QIcon(ADD_DATE_ICON_PATH), ADD_DATE_TOOLTIP, this);
    connect(action, &QAction::triggered, this, &MainWindow::onAddDateToTextActionTriggered);
    ui->toolBar->addAction(action);
}
